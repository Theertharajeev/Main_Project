...
def read_dataset(path):
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\user\Desktop\data\train')
    for pa in my_list:
        i=i+1
        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\user\Desktop\data\train\\' + pa):

         for f in files:
             try:
                file_path = os.path.join(r'C:\Users\user\Desktop\data\train\\'+pa, f)
...
# load dataset
x_dataset, y_dataset = read_dataset(r"C:\Users\user\Desktop\data\train")
...
if not os.path.exists("cnn_modelnew_weights.h5"):
    ...
    labels = ["Class 1", "Class 2", "Class 3", "Class 4", "Class 5", "Class 6", "Class 7", "Class 8", "Class 9",
              "Class 10"]
