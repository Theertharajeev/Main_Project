...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\ismfa\OneDrive\Desktop\dataset download\data\train')
    i=-1
    ii=0
    for pa in my_list:
        ...
        print(pa,"==================")
        i=i+1
        for root, dirs, files in os.walk(r'C:\Users\ismfa\OneDrive\Desktop\dataset download\data\train\\' + pa):

         for f in files:


             file_path = os.path.join(r'C:\Users\ismfa\OneDrive\Desktop\dataset download\data\train\\'+pa, f)
...
# load dataset
x_dataset, y_dataset = read_dataset(r"C:\Users\ismfa\OneDrive\Desktop\dataset download\data\train")
...
target_names = ['infected', 'notinfected']
